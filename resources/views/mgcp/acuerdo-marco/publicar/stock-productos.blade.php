    ...
    <div class="box-body">
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-3" id="tdAcuerdos">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            const TIPO_CAMBIO = parseFloat('{{$tipoCambio}}');
            ...
            function obtenerProductos() {
                ...
                $divProductos.html('');
                $.ajax({
                    url: "{{route('mgcp.acuerdo-marco.publicar.stock-productos.obtener-productos')}}",
                    type: 'post',
                    data: {
                        idEmpresa: $selectEmpresa.val(),
                        idAcuerdo: $selectAcuerdos.val(),
            ...
            function procesar() {
                if (filaActual < totalFilas) {
                    ...
                    $.ajax({
                        url: "{{route('mgcp.acuerdo-marco.publicar.stock-productos.procesar')}}",
                        type: 'post',
                        data: {
                            idEmpresa: $selectEmpresa.val(),
