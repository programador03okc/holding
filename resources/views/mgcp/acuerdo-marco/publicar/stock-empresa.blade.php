    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formSubirArchivos" method="post" action="{{route('mgcp.acuerdo-marco.publicar.stock-empresa.procesar-archivo')}}" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <a href="{{route('mgcp.acuerdo-marco.publicar.stock-empresa.descargar-plantilla')}}" target="_blank">Descargar plantilla</a>
                        </div>
...
@section('scripts')
<script src='{{ asset("mgcp/js/util.js?v=25") }}'></script>
<script>
    $(document).ready(function() {
        ...
        $('#btnIniciar').click(function() {
            ...
            $.ajax({
                url: "{{route('mgcp.acuerdo-marco.publicar.stock-empresa.obtener-productos')}}",
                type: 'post',
                //dataType: 'json',
                data: {
        ...
        function procesar() {
            if (filaActual < totalFilas) {
                ...
                $.ajax({
                    url: "{{route('mgcp.acuerdo-marco.publicar.stock-empresa.enviar-portal')}}",
                    type: 'post',
                    data: {
                        idEmpresa: $selectEmpresa.val(),
