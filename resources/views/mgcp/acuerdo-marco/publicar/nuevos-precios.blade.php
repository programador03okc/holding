    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formSubirArchivos" method="post" action="{{route('mgcp.acuerdo-marco.publicar.nuevos-precios.procesar-archivo')}}" class="form-horizontal">
...
<script>
    $(document).ready(function () {
        ...
        $('#btnIniciar').click(function () {
            ...
            $.ajax({
                url: "{{route('mgcp.acuerdo-marco.publicar.nuevos-precios.obtener-productos')}}",
                type: 'post',
                //dataType: 'json',
        ...
        function procesar()
        {
            if (filaActual < totalFilas)
            {
                ...
                $.ajax({
                    url: "{{route('mgcp.acuerdo-marco.publicar.nuevos-precios.procesar')}}",
                    type: 'post',
                    data: {
