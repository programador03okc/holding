...
@section('cabecera') Descarga de productos adjudicados @endsection
            ...
            <div class="col-md-12">
                <div class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <button id="btnIniciar" disabled class="btn btn-primary btn-flat">Iniciar</button> 
        ...
        $(document).ready(function () {
            ...
            $botonObtenerAcuerdos.click(function () {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    dataType: 'json',
                    data: {idEmpresa: $selectEmpresa.val(), pagina: 'productos', _token: "{{csrf_token()}}"},
            ...
            function obtenerCatalogos() {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    data: {idEmpresa: $selectEmpresa.val(), idAcuerdo: $selectAcuerdos.val(), _token: "{{csrf_token()}}"},
                    success: function (resultado) {
                        if (resultado.tipo == 'success')
                        {
                            if (resultado.data.length > 0)
            ...
            function obtenerCategorias() {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    data: {idEmpresa: $selectEmpresa.val(), idCatalogo: $selectCatalogos.find('option:eq(' + indiceCatalogo + ')').val(), _token: "{{csrf_token()}}"},
                    success: function (resultado) {
                        if (resultado.tipo == 'success')
                        {
                            indiceCategoria = 0;
            ...
            function obtenerProductos() {
                ...
                $.ajax({
                    url: "{{route('mgcp.acuerdo-marco.descargar.productos-adjudicados.obtener-productos')}}",
                    type: 'post',
            ...
            function procesarProductos() {
                if (filaActual < totalFilas) {
                    ...
                    $.ajax({
                        url: "{{route('mgcp.acuerdo-marco.descargar.productos-adjudicados.procesar')}}",
                        type: 'post',
                        data: {
