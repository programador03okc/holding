                ...
                <form class="form-horizontal" id="formFiltros">
                    ...
                    <div class="form-group">
                        <label class="col-sm-12">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="chkAdjudicados" @if (session('prod_adjudicados') !==null) checked @endif> Sólo productos adjudicados en al menos una empresa
                                </label>
                            </div>
                        </label>
                    </div>
...
@section('scripts')
    ...
    <script src='{{ asset("mgcp/js/acuerdo-marco/producto/producto-view.js?v=16") }}'></script>
    <script src='{{ asset("mgcp/js/acuerdo-marco/producto/historial-model.js?v=10") }}'></script>
    <script src='{{ asset("mgcp/js/acuerdo-marco/producto/historial-view.js?v=12") }}'></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            const userEmpresa = '{{ Auth::user()->id_empresa }}';
            ...
            productoView.listar(userEmpresa);
