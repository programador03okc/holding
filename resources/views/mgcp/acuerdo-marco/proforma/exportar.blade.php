...
@section('cuerpo')
    ...
    <div class="box box-solid">
        <div class="box-body">
            ...
            <br>
            <form class="form-horizontal" method="POST" target="_blank" action="{{route('mgcp.acuerdo-marco.proformas.exportar.generar-archivo')}}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <select class="selectpicker" data-live-search="true" data-width="100%" data-actions-box="true" multiple data-size="10" name="catalogo[]">
                            ...
                            <option selected value="{{$catalogo->id}}">{{$catalogo->descripcion}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-sm-2">
                        <select class="selectpicker" data-live-search="true" data-width="100%" data-actions-box="true" multiple data-size="10" name="estado[]">
                            ...
                            <option selected value="{{$estado->estado}}">{{$estado->estado}}</option>
                            @endforeach
                        </select>
                    </div>
