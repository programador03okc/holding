<header class="main-header">
    <a href="{{route('mgcp.home')}}" class="logo">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    <a href="{{route('mgcp.notificaciones.lista')}}" class="dropdown-toggle">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer"><a href="{{route('mgcp.notificaciones.lista')}}">Ver todo</a></li>
                    </ul>
                    -->
                </li>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{route('mgcp.perfil.cambiar-password')}}" class="btn btn-default btn-flat">Cambiar contraseña</a>
                            </div>
