...
<form method="POST" action="<?php echo e(route('mgcp.ordenes-compra.propias.directas.registrar')); ?>" id="formRegistrarOc" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select name="empresa" class="form-control">
                            ...
                            <option <?php echo e(old('empresa') == $empresa->id ? 'selected' : ''); ?> value="<?php echo e($empresa->id); ?>"><?php echo e($empresa->empresa); ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select class="selectpicker" data-live-search="true" data-width="100%" data-actions-box="true" data-size="10" name="responsable">
                            ...
                            <option <?php echo e(old('responsable') == $responsable->id ? 'selected' : ''); ?> value="<?php echo e($responsable->id); ?>"><?php echo e($responsable->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <?php else: ?>
    ...
    <!--<div class="box box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Campos opcionales</h3>
                </div>
                <div class="box-body">
                    <p>Estos campos se pueden editar más adelante en la lista de O/C</p>
                    <br>
                    <div class="form-horizontal">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Guía</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="guia" value="<?php echo e(old('guia')); ?>"
                                    placeholder="Guía">
                            </div>
                            <label class="col-sm-2 control-label">Fecha de guía</label>
                            <div class="col-sm-4">
                                <input type="text" autocomplete="off" placeholder="dd-mm-aaaa" name="fecha_guia"
                                    value="<?php echo e(old('fecha_guia')); ?>" class="form-control date-picker">
                                <small class="help-block" style="margin-bottom: 0px">dd-mm-aaaa</small>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="factura" value="<?php echo e(old('factura')); ?>"
                                    placeholder="Factura">
                            </div>
                            <label class="col-sm-2 control-label">SIAF</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="siaf" value="<?php echo e(old('siaf')); ?>"
                                    placeholder="SIAF">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select name="etapa" class="form-control">
                                    ...
                                    <option <?php echo e(old('etapa') == $etapa->id ? 'selected' : ''); ?> value="<?php echo e($etapa->id); ?>"><?php echo e($etapa->etapa); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <label class="col-sm-2 control-label">Nro. O/C física</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" placeholder="Nro. O/C física" name="orden_compra" value="<?php echo e(old('orden_compra')); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Despachada</label>
                            <div class="col-sm-1">
                                <select name="despachada" class="form-control">
                                    <option <?php echo e(old('despachada') == '0' ? 'selected' : ''); ?> value="0">No</option>
                                    <option <?php echo e(old('despachada') == '1' ? 'selected' : ''); ?> value="1">Sí</option>
                                </select>
                            </div>
                            <label class="col-sm-2 control-label">Cobrado</label>
                            <div class="col-sm-1">
                                <select name="cobrado" class="form-control">
                                    <option <?php echo e(old('cobrado') == '0' ? 'selected' : ''); ?> value="0">No</option>
                                    <option <?php echo e(old('cobrado') == '1' ? 'selected' : ''); ?> value="1">Sí</option>
                                </select>
                            </div>
                            <label class="col-sm-2 control-label">Conformidad</label>
                            <div class="col-sm-1">
                                <select name="conformidad" class="form-control">
                                    <option <?php echo e(old('conformidad') == '0' ? 'selected' : ''); ?> value="0">No</option>
                                    <option <?php echo e(old('conformidad') == '1' ? 'selected' : ''); ?> value="1">Sí</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mgcp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mgcp\resources\views/mgcp/orden-compra/propia/directa/nueva.blade.php ENDPATH**/ ?>