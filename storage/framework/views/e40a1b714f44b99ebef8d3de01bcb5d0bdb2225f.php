...
<ol class="breadcrumb">
    ...
    <li class="active"><?php echo e($tipoProforma == '1' ? 'Compra ordinaria' : 'Gran compra'); ?> (nueva)</li>
</ol>
<?php $__env->stopSection(); ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-inline text-center">
                    ...
                    <?php if(Auth::user()->tieneRol(68)): ?>
                    <button class="btn btn-default" data-tipo="<?php echo e($tipoProforma); ?>" id="btnDescargarAnalisis"><span class="fa fa-download"></span> Formato de análisis</button>
                    <?php endif; ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="formFiltros">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="tipoProforma" value="<?php echo e($tipoProforma); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="selectEstado" class="form-control">
                                ...
                                <option value="<?php echo e($estado->estado); ?>" <?php echo e($estado->estado=='PENDIENTE' ? 'selected' : ''); ?>><?php echo e($estado->estado); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-4">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="chkTipoCarga"  <?php if(session('proformaTipoCarga') !== null): ?> checked <?php endif; ?>> Tipo de carga
                                </label>
                            </div>
                        </label>
                        <div class="col-sm-8">
                            <select name="selectTipoCarga" class="form-control">
                                <option value="" <?php echo e(session('proformaTipoCarga') == null ? 'selected' : ''); ?> disabled>Elija una opción</option>
                                <option value="MANUAL" <?php echo e(session('proformaTipoCarga') == 'MANUAL' ? 'selected' : ''); ?>>MANUAL</option>
                                <option value="MASIVO" <?php echo e(session('proformaTipoCarga') == 'MASIVO' ? 'selected' : ''); ?>>MASIVO</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-12">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="chkMPG"  <?php if(session('proformaMPG') !== null): ?> checked <?php endif; ?>> Mayor probabilidad de ganar
                                </label>
                            </div>
                        </label>
                    </div>
                ...
                <div class="box box-solid last">
                    <div class="box-body">
                        <form id="formAnalisis">
                            ...
                            <input type="hidden" name="id_tipo_proforma" id="id_tipo_proforma" value="<?php echo e($tipoProforma); ?>">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src='<?php echo e(asset("mgcp/js/orden-compra/publica/orden-compra-publica-model.js?v=20")); ?>'></script>
    <script src='<?php echo e(asset("mgcp/js/orden-compra/publica/orden-compra-publica-view.js?v=20")); ?>'></script>

    <script src='<?php echo e(asset("mgcp/js/acuerdo-marco/proforma/calculadora-model.js?v=26")); ?>'></script>
    <script src='<?php echo e(asset("mgcp/js/acuerdo-marco/proforma/calculadora-view.js?v=26")); ?>'></script>
    ...
    import CONuevaVistaModel from '<?php echo e(asset("mgcp/js/acuerdo-marco/proforma/individual/compra-ordinaria/co-nueva-vista-model.js?v=23")); ?>'
    import CONuevaVistaView from '<?php echo e(asset("mgcp/js/acuerdo-marco/proforma/individual/compra-ordinaria/co-nueva-vista-view.js?v=23")); ?>'
    import ProformaNuevaVistaModel from '<?php echo e(asset("mgcp/js/acuerdo-marco/proforma/individual/proforma-nueva-vista-model.js?v=23")); ?>'
    import ProformaIndividualView from '<?php echo e(asset("mgcp/js/acuerdo-marco/proforma/individual/proforma-individual-view.js?v=23")); ?>'
    ...
    $(document).ready(function() {
        ...
        if (tipoProforma == '1') {
            ...
            proformaNvView = new CONuevaVistaView(proformaModel, "<?php echo e(Auth::user()->id); ?>");
            proformaNvView.ingresarFletePorLoteEvent();
        } else {
            proformaModel = new ProformaNuevaVistaModel(token);
            proformaNvView = new CONuevaVistaView(proformaModel, "<?php echo e(Auth::user()->id); ?>");
        }
        const proformaIndView = new ProformaIndividualView(proformaModel, "<?php echo e(Auth::user()->id); ?>");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mgcp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\holding\resources\views/mgcp/acuerdo-marco/proforma/individual/nueva-vista.blade.php ENDPATH**/ ?>