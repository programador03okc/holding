    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formSubirArchivos" method="post" action="<?php echo e(route('mgcp.acuerdo-marco.publicar.nuevos-productos.procesar-archivo')); ?>" class="form-horizontal">
...
<script>
    $(document).ready(function () {
        ...
        $('#btnIniciar').click(function () {
            ...
            $.ajax({
                url: "<?php echo e(route('mgcp.acuerdo-marco.publicar.nuevos-productos.obtener-productos')); ?>",
                type: 'post',
                //dataType: 'json',
                data: {idEmpresa: $selectEmpresa.val(), tipo: $selectTipo.val(), _token: "<?php echo e(csrf_token()); ?>"},
        ...
        function procesar()
        {
            if (filaActual < totalFilas)
            {
                ...
                $.ajax({
                    url: "<?php echo e(route('mgcp.acuerdo-marco.publicar.nuevos-productos.procesar')); ?>",
                    type: 'post',
                    data: {
...
<?php echo $__env->make('mgcp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\holding\resources\views/mgcp/acuerdo-marco/publicar/nuevos-productos.blade.php ENDPATH**/ ?>