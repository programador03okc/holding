    ...
    $(document).ready(function () {
        ...
        var $tableDatos = $('#tableDatos').DataTable({
            ...
            columnDefs: [
                ...
                {render: function (data, type, row) {
                        var botones = '<a target="_blank" href="' + "<?php echo e(url('/mgcp/notificaciones/ver')); ?>/" + row.id + '" title="Ver" class="btn btn-primary btn-xs visitar"><span class="glyphicon glyphicon-eye-open"></span></a>';
            ...
            order: [[0, "desc"]],
            ajax: {
                url: "<?php echo e(route('mgcp.notificaciones.data-lista')); ?>",
                type: "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mgcp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mgcp_empresa\resources\views/mgcp/usuario/notificacion.blade.php ENDPATH**/ ?>