...
<?php $__env->startSection('cabecera'); ?> Descargar detalles de O/C públicas <?php $__env->stopSection(); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="form-control" id="selectAcuerdo">
                        ...
                        <option value="<?php echo e($acuerdo->id); ?>"><?php echo e($acuerdo->descripcion); ?> <?php echo e($acuerdo->descripcion_larga); ?></option>
                ...
                <div class="col-md-4">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control text-center date-picker" id="txtDesde" value="<?php echo e(date('d-m-Y')); ?>">
                            <small class="help-block">Desde (dd-mm-aaaa)</small>
                        </div>
                        <div class="col-sm-5">
                            <input type="text" class="form-control text-center date-picker" id="txtHasta" value="<?php echo e(date('d-m-Y')); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnIniciar').on('click', () => {
                ...
                $.ajax({
                    url: "<?php echo e(route('mgcp.acuerdo-marco.descargar.ordenes-compra-publicas.obtener-detalles')); ?>",
                    type: 'post',
                    dataType: 'json',
                    data: {
                        acuerdo: $acuerdo.val(),
            ...
            function procesar() {
                if (contador < total) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('mgcp.acuerdo-marco.descargar.ordenes-compra-publicas.procesar')); ?>",
                        type: 'post',
                        dataType: 'json',
                        data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mgcp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\holding\resources\views/mgcp/acuerdo-marco/descarga/oc-publicas/detalles.blade.php ENDPATH**/ ?>