<?php $__env->startSection('cabecera'); ?> Descargar nuevos productos <?php $__env->stopSection(); ?>
...
<script>
    $(document).ready(function() {
        ...
        function obtenerProductos() {
            ...
            $.ajax({
                url: "<?php echo e(route('mgcp.acuerdo-marco.descargar.nuevos-productos.obtener-productos')); ?>",
                type: 'post',
                data: {
                    idEmpresa: $selectEmpresa.val(),
                    idAcuerdo: $selectAcuerdos.val(),
        ...
        function procesarProductos() {
            if (filaActual < totalFilas) {
                ...
                $.ajax({
                    url: "<?php echo e(route('mgcp.acuerdo-marco.descargar.nuevos-productos.procesar')); ?>",
                    type: 'post',
                    data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mgcp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\holding\resources\views/mgcp/acuerdo-marco/descarga/nuevos_productos.blade.php ENDPATH**/ ?>