                    ...
                    <table id="table_resumen_vendedores" class="table table-condensed" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php $__currentLoopData = $detalles[$cont]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="text-right"><span style="cursor: pointer; color: #337ab7" class="detallesMonto" data-moneda="s" data-corporativo="<?php echo e($responsable->id); ?>" data-estado="<?php echo e($codEstado); ?>">S/ <?php echo e(number_format($detalle->suma_soles,2,'.',',')); ?></span><br><span style="cursor: pointer; color: #337ab7" class="detallesMonto" data-moneda="d" data-corporativo="<?php echo e($responsable->id); ?>" data-estado="<?php echo e($codEstado); ?>">$ <?php echo e(number_format($detalle->suma_dolares,2,'.',',')); ?></span>
                                </td>
                                <?php
                                $codEstado++;
                                ?>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <?php $__currentLoopData = $sumas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suma): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td class="text-right"><strong>S/ <?php echo e(number_format($suma->suma_soles,2,'.',',')); ?><br>$ <?php echo e(number_format($suma->suma_dolares,2,'.',',')); ?></strong></td>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                        </tfoot>
                    </table>
...
<script src='<?php echo e(asset("assets/chartjs/Chart.bundle.min.js")); ?>'></script>
<script>
    $(document).ready(function () {
        Util.seleccionarMenu(window.location);
        var url = "<?php echo e(url('/mgcp')); ?>";
        $('span.detallesMonto').click(function () {
            ...
            $.ajax({
                url: "<?php echo e(route('mgcp.oportunidades.resumen-detalles-monto')); ?>",
                type: 'post',
                dataType: 'json',
                data: {codEstado: $span.data('estado'), corporativo: $span.data('corporativo'), moneda: $span.data('moneda'), _token: '<?php echo e(csrf_token()); ?>'},
...
//Chart de resumen de oportunidades
        $.ajax({
            url: "<?php echo e(route('mgcp.oportunidades.resumen-data')); ?>",
            type: 'post',
            dataType: 'json',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mgcp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mgcp_empresa\resources\views/mgcp/oportunidad/resumen.blade.php ENDPATH**/ ?>