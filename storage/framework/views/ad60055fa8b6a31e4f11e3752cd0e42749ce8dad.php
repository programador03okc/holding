...
Proformas de <?php echo e($tipoProforma=='1' ? 'compra ordinaria' : 'gran compra'); ?> por paquete
<?php $__env->stopSection(); ?>
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="formFiltros">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="fechaEmisionDesde" class="form-control date-picker actualizar" value="<?php if(session('proformaFechaEmisionDesde') !==null): ?> <?php echo e(session('proformaFechaEmisionDesde')); ?><?php else: ?><?php echo e($fechaActual->addMonths(-1)->format('d-m-Y')); ?> <?php endif; ?>">
                            <small class="help-block">Desde (dd-mm-aaaa)</small>
                        </div>
                        <div class="col-sm-4">
                            <input type="text" name="fechaEmisionHasta" class="form-control date-picker actualizar" value="<?php if(session('proformaFechaEmisionHasta') !==null): ?> <?php echo e(session('proformaFechaEmisionHasta')); ?><?php else: ?><?php echo e($fechaActual->addMonths(1)->format('d-m-Y')); ?> <?php endif; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="selectEstado" class="form-control">
                                ...
                                <option value="<?php echo e($estado->estado); ?>" <?php echo e($estado->estado == 'PENDIENTE' ? 'selected' : ''); ?>>
...
<script src='<?php echo e(asset("mgcp/js/acuerdo-marco/proforma/paquete/paquete-view.js?v=5")); ?>'></script>
<script src='<?php echo e(asset("mgcp/js/acuerdo-marco/proforma/paquete/paquete-model.js?v=2")); ?>'></script>

<script src='<?php echo e(asset("mgcp/js/acuerdo-marco/proforma/calculadora-model.js?v=22")); ?>'></script>
<script src='<?php echo e(asset("mgcp/js/acuerdo-marco/proforma/calculadora-view.js?v=24")); ?>'></script>
...
<script>
    $(document).ready(function() {
        ...
        const paqueteView = new PaqueteView(new PaqueteModel(token,tipoProforma),tipoProforma,'<?php echo e(Auth::user()->id); ?>');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mgcp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\holding\resources\views/mgcp/acuerdo-marco/proforma/paquete/vista.blade.php ENDPATH**/ ?>