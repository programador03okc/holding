                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button id="btnEditarFueraMonto" title="Editar" class="btn btn-primary editar btn-xs"
                                    data-id="<?php echo e($aprobadorFueraMonto->id); ?>" data-usuario="<?php echo e($aprobadorFueraMonto->usuario->id); ?>">
        ...
        $(document).ready(function () {
            ...
            $('#btnActualizarAprobadorFueraMonto').click(function () {
                ...
                $.ajax({
                    ...
                    data: { id: $('#idFueraMonto').val(), usuario: $('#selectAprobadoresFueraMonto').val(), _token: '<?php echo e(csrf_token()); ?>'},
                    type: 'POST',
                    dataType: 'json',
                    success: function (data) {
                        alert(data.mensaje);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('mgcp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\holding\resources\views/mgcp/cuadro-costo/ajuste/aprobadores.blade.php ENDPATH**/ ?>