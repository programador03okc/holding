                    ...
                    <table id="tablePorMonto" class="table table-condensed table-hover" style="font-size: small; width: 100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <input type="hidden" name="id[]" value="<?php echo e($indicador->id); ?>">
...
<?php echo $__env->make('mgcp.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\holding\resources\views/mgcp/orden-compra/propia/configuracion-indicadores.blade.php ENDPATH**/ ?>