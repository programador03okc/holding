...
class CreateProformasCompraOrdinariaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mgcp_acuerdo_marco.proformas_compra_ordinaria', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mgcp_acuerdo_marco.proformas_compra_ordinaria');
    }
}
