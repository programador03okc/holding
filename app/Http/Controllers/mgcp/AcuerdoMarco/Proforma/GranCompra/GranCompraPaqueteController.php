...
class GranCompraPaqueteController extends Controller
{
    private $nombreFormulario = 'Proforma gran compra por paquete';
    ...
    public function index()
    {
        ...
        return view('mgcp.acuerdo-marco.proforma.paquete.vista')->with(compact('empresas', 'estados', 'fechaActual', 'tipoProforma'));
    }
}
